...
```bash
cd
git clone https://github.com/Ishant2005-tech/Dental-Disease-Detection.git
...
Download the model weights from [Kaggle](https://www.kaggle.com/datasets/ishantrajkashyap/dental-disease-detection) and place the files in the root of the `Dental-Disease-Detection` directory.
